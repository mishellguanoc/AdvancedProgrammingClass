...
public:
   ...
   */
  std::optional<Course> find_course(std::string course_title)  // ✅ Paso 2: Cambiamos FillMeIn por std::optional<Course>
  {
...
main(int argc, char* argv[])
{
  ...
  if (argc == 2) {
    ...
    std::string output = course
      ...
      .value_or("Course not found.");  // ✅ Paso 3: Usamos transform y value_or
